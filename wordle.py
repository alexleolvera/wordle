...
VALID_GUESSES = set(WORDS) | {
    ...
    "house", "human", "humor", "hurry", "hyena", "hyper", "ideal", "image", "imply",
    ...
    "lease", "least", "leave", "legal", "level", "light", "limit", "liner", "links",
    ...
    "vivid", "vocal", "voice", "voter", "wager", "waist", "watch", "water", "weary",
